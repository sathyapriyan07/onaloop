  ...
  return (
    <section className="relative overflow-hidden" style={{ background: 'var(--surface)', minHeight: 440 }}>
      ...
      <button
        ...
        className="absolute left-1/2 -translate-x-1/2 bottom-16 rounded-full px-14 py-3.5 text-[18px] font-bold tracking-tight shadow-[0_18px_70px_rgba(0,0,0,0.35)] hover:opacity-90 transition-opacity"
