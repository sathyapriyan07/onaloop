  ...
  return (
    <AuthLayout>
      <div className="w-full max-w-sm space-y-7">
        <div>
          <h1 className="otl-title text-[var(--label)]">Welcome back</h1>
          <p className="mt-1 text-sm text-[var(--label3)]">Sign in to OnTheLoop</p>
        </div>
        ...
        <p className="text-center text-sm text-[var(--label3)]">
          No account?{' '}
          <Link to="/signup" className="font-semibold text-accent hover:opacity-80">Create one</Link>
        </p>
      </div>
    </AuthLayout>
  )
