...
export default function SeriesDetailPage() {
  ...
  return (
    <div>
      ...
      <div className="mx-auto w-full max-w-screen-xl px-4 pb-10 space-y-6">
        {series.overview ? (
          <Expandable
        ...
        <div className="rounded-2xl border p-4 space-y-4" style={{ background: 'var(--surface)', borderColor: 'var(--separator)' }}>
